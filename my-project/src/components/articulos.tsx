...
export function Articulos({title, description, image}) {
    ...
    return (
        <a href="" className="mx-3 flex flex-col items-center bg-white border border-sky-200 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100">
            <img className="object-cover w-full rounded-t-lg md:h-64 md:w-48 md:rounded-none md:rounded-s-lg md:h-auto" src={imagearticles[image]} alt="" />
